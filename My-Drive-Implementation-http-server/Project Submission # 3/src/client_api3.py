...
if __name__ == "__main__":
    ...
    config_file_path = r'src/dfs_setup.config'
    ...
    def on_upload_button_click():
        file_path = filedialog.askopenfilename(initialdir="upload_list", title="Select file")
        if file_path:
            upload_file_to_chunk_servers(file_path, chunk_servers, chunk_size, master_key, replication_factor)

    def on_download_button_click():
        metadata_file_path = r'C:\Users\saadh\OneDrive\Desktop\My-Drive-Implementation-Adv-OS-Project\Project Submission # 3\metadata_uploaded.json'
        ...
        if metadata:
            ...
            if file_names:
                def select_file():
                    ...
                    if selected_file:
                        output_path = r"C:\Users\saadh\OneDrive\Desktop\My-Drive-Implementation-Adv-OS-Project\Project Submission # 3\src\outputs\saad\output.txt"
