...
def splitFile(file_path, chunk_size, encryption_key, authenticated_user, temp_dir):
    metadata = {"chunks": []}
    ...
    with open(file_path, 'rb') as f:
        for i in range(num_chunks):
            ...
            chunk_name = f"{authenticated_user}_{file_name}_chunk_{i}.dat"
...
def mergeChunks(metadata, temp_dir, output_file, encryption_key):
    decrypted_chunks = []
